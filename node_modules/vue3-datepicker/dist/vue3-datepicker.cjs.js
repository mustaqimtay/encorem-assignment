...
const _withId$1 = /*#__PURE__*/vue.withScopeId("data-v-2e128338");

vue.pushScopeId("data-v-2e128338");
const _hoisted_1$2 = { class: "v3dp__heading" };
const _hoisted_2$2 = /*#__PURE__*/vue.createVNode("svg", {
...
var script$1 = vue.defineComponent({
    ...
    setup(props, { emit }) {
        const hoursListRef = vue.ref(null);
        const minutesListRef = vue.ref(null);
        const currentDate = vue.computed(() => { var _a; return (_a = props.pageDate) !== null && _a !== void 0 ? _a : props.selected; });
        const hours = vue.ref(currentDate.value.getHours());
        const minutes = vue.ref(currentDate.value.getMinutes());
        vue.watch(() => props.selected, (value) => {
            let newHours = 0;
            let newMinutes = 0;
            if (value) {
        ...
        const hoursList = vue.computed(() => [...Array(24).keys()].map((value) => ({
            value,
            date: dateFns.set(new Date(currentDate.value.getTime()), { hours: value, minutes: minutes.value, seconds: 0 }),
            selected: hours.value === value,
            ref: vue.ref(null)
        })));
        const minutesList = vue.computed(() => [...Array(60).keys()].map((value) => ({
            value,
            date: dateFns.set(new Date(currentDate.value.getTime()), { hours: hours.value, minutes: value, seconds: 0 }),
        ...
        const isEnabled = (target) => {
            var _a, _b, _c, _d;
            if ((_b = (_a = props.disabledTime) === null || _a === void 0 ? void 0 : _a.dates) === null || _b === void 0 ? void 0 : _b.some(date => dateFns.isSameHour(target, date) && dateFns.isSameMinute(target, date))) {
                return false;
            }
...
const _withId = /*#__PURE__*/vue.withScopeId("data-v-e1b37236");

vue.pushScopeId("data-v-e1b37236");
const _hoisted_1$1 = {
  ref: "hoursListRef",
  class: "v3dp__column"
};
...
const render$1 = /*#__PURE__*/_withId((_ctx, _cache, $props, $setup, $data, $options) => {
  ...
  return (vue.openBlock(), vue.createBlock(_component_picker_popup, {
    ...
    heading: _withId(() => [
      vue.createTextVNode(vue.toDisplayString(_ctx.padStartZero(_ctx.hours)) + ":" + vue.toDisplayString(_ctx.padStartZero(_ctx.minutes)), 1 /* TEXT */)
    ]),
    body: _withId(() => [
      vue.createVNode("div", _hoisted_1$1, [
        (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(_ctx.hoursList, (item) => {
          return (vue.openBlock(), vue.createBlock("button", {
            key: item.value,
            ref: item.ref,
            class: { selected: item.selected },
            disabled: !_ctx.isEnabled(item.date),
            onClick: vue.withModifiers($event => (_ctx.hours=item.value), ["stop","prevent"])
          }, [
            vue.createVNode("span", null, vue.toDisplayString(_ctx.padStartZero(item.value)), 1 /* TEXT */)
          ], 10 /* CLASS, PROPS */, ["disabled", "onClick"]))
        }), 128 /* KEYED_FRAGMENT */))
      ], 512 /* NEED_PATCH */),
      vue.createVNode("div", _hoisted_2$1, [
        (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(_ctx.minutesList, (item) => {
          return (vue.openBlock(), vue.createBlock("button", {
            key: item.value,
            ref: item.ref,
            class: { selected: item.selected },
            disabled: !_ctx.isEnabled(item.date),
            onClick: vue.withModifiers($event => (_ctx.selectMinutes(item)), ["stop","prevent"])
          }, [
            vue.createVNode("span", null, vue.toDisplayString(_ctx.padStartZero(item.value)), 1 /* TEXT */)
          ], 10 /* CLASS, PROPS */, ["disabled", "onClick"]))
        }), 128 /* KEYED_FRAGMENT */))
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (vue.openBlock(), vue.createBlock("div", {
    ...
    vue.withDirectives(vue.createVNode(_component_time_picker, {
      pageDate: _ctx.pageDate,
